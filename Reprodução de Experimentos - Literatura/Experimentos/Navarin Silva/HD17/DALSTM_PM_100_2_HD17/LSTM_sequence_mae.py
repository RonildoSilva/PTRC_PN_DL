...
#train the model
model.fit(X_train, y_train, validation_split=0.5,  callbacks=[early_stopping, model_checkpoint,lr_reducer],epochs=500, batch_size=maxlen)
...
#2 X 75
#Root Mean Squared Error: 10.7414 d MAE: 8.5425 d MAPE: 888631886514.1418%
